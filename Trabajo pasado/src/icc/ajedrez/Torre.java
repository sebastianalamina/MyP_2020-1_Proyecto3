...
/**Clase para la torre del ajedrez.
*@author Sebastián A.
*/
public class Torre extends Pieza {

	/**Método constructor para la torre.
	*@param columna Columna en la que irá la pieza.
	*@param renglón Renglón en el que irá la pieza.
	*@param color Color de la pieza.
	*/
	public Torre(char columna, int renglón, boolean color) {
		super(columna, renglón, color);
	} //Fin de constructor Torre.
	...
	*/
	public String toString() {
		String colorTorre;
		if (getColor()) {colorTorre = "blanca";} else {colorTorre = "negra";}
		return "Esta torre "+colorTorre+" se encuentra en la posición: ("+getColumna()+","+getRenglón()+").";
	}
